"use strict";(self.webpackChunkidofactory=self.webpackChunkidofactory||[]).push([[9214],{39214:(e,t,i)=>{i.r(t),i.d(t,{W3mWalletReceiveView:()=>x});var r=i(66386),o=i(43756),n=i(54417),a=i(83520),s=i(90891),l=i(66107),c=i(86533),u=i(95174),d=i(8632),w=i(82880),p=i(52105),h=(i(83426),i(72738),i(26576),i(19658),i(50745)),m=i(32603);const f=i(10109).iv`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var v=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"===typeof Reflect&&"function"===typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let g=class extends r.oi{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return r.dy`
    ...
    </wui-flex>`}};g.styles=[h.ET,h.ZM,f],v([(0,o.Cb)({type:Array})],g.prototype,"networkImages",void 0),v([(0,o.Cb)()],g.prototype,"text",void 0),g=v([(0,m.M)("wui-compatible-network")],g);i(78330),i(35359),i(43549);var b=i(36839);const k=p.iv`
...
//# sourceMappingURL=9214.chunk.js.map